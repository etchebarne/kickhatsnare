...
use kickhatsnare_protocol::{ErrorCode, library::GetLibraryParams};
use serde_json::Value;

use super::{ApiError, core_error, serialize_snapshot};

pub(super) fn handle(params: &Value, library: &Library) -> Result<Value, ApiError> {
    serde_json::from_value::<GetLibraryParams>(params.clone())
